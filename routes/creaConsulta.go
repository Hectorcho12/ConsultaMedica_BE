...
/*CreaConsulta metodo para crea consulta a paciente*/
func CreaConsulta(w http.ResponseWriter, r *http.Request) {
	...
	errorConsulta := m.Insert(dbref)

	if errorConsulta != nil {
		http.Error(w, "Error al guardar consulta. ERROR: "+errorConsulta.Error(), 400)
		return
	}
